...
;(function(window){
	var OZ = (function(){
		var _reportURL = window.location.protocol === 'http:' ? '//iyouxi3.vip.qq.com/ams3.0.php?_c=oz&oz_v=1': '//h5.vip.qq.com/p/iyouxi3/ams3.0.php?_c=oz&oz_v=1';
		var _imgObjs = [];
		var _config = {
			actid: '', 	 		// 活动id
			actName: '', 		// 活动名称
		...
		*/
		...
		pub.report = function(oConfig) {
			...
			var platform = typeof mqq !== 'undefined' ? (mqq.iOS ? 1 : 2 ) : 0;//1：ios; 2:android
			var qq_version = typeof mqq !== 'undefined' ? mqq.QQVersion : 'unknown';
			...
			var url = [_reportURL,
					   ...
					   "&appid=", getAppid(),"&aim=", aim, "&pageindex=", pageindex,
					   "&t=", (new Date()).getTime(),
						"&platform=", platform, "&qq_version=", qq_version
				].join("");
