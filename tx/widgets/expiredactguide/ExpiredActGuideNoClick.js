(function($) {
    window.expiredActGuide = function(page){
        page.addReadyFire(function(){
            ...
            ConfigManager.prototype.getGuide = function(page){
                if(page && page.pcfg && page.pcfg.aid && page.pcfg.aid.indexOf('.youxi.') > -1 &&
                   window.location.href.indexOf('http://youxi.vip.qq.com/m/act/') > -1){
            ...
            zUtil.require('aop', function(){ 
                zAOP.intercept_a_s('send', { after : function(param){ //拦截send方法
